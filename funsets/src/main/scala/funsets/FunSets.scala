...
object FunSets {
   ...
   */
  def singletonSet(elem: Int): Set = (some_elem: Int) => some_elem == elem 
  
  /**
   * Returns the set of odd numbers, for testing other functions
   */
  def oddSet(): Set = (elem: Int) => elem % 2 == 1 || elem % 2 == -1
